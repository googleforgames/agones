...
/*
SDKApiService Apply multiple Annotations to the backing GameServer metadata
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
@return SdkEmpty
*/
func (a *SDKApiService) SetAnnotations(ctx context.Context, body SdkKeyValues) (SdkEmpty, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/metadata/annotations"
