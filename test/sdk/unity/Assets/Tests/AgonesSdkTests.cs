...
public class AgonesSdkTests
{
    ...
    public IEnumerator UnitySetUp() {
        yield return UnityEngine.SceneManagement.SceneManager.LoadSceneAsync("SampleScene", UnityEngine.SceneManagement.LoadSceneMode.Single);
        GameObject gameObject = GameObject.Find("AgonesSdks");
