...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WebhookFallback) DeepCopyInto(out *WebhookFallback) {
	*out = *in
	in.Policy.DeepCopyInto(&out.Policy)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WebhookFallback.
func (in *WebhookFallback) DeepCopy() *WebhookFallback {
	if in == nil {
		return nil
	}
	out := new(WebhookFallback)
	in.DeepCopyInto(out)
	return out
}
