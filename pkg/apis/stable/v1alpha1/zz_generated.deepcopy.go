...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (gsSet *GameServerSet) DeepCopyInto(out *GameServerSet) {
	*out = *gsSet
	out.TypeMeta = gsSet.TypeMeta
	gsSet.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	gsSet.Spec.DeepCopyInto(&out.Spec)
	out.Status = gsSet.Status
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GameServerSet.
func (gsSet *GameServerSet) DeepCopy() *GameServerSet {
	if gsSet == nil {
		return nil
	}
	out := new(GameServerSet)
	gsSet.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (gsSet *GameServerSet) DeepCopyObject() runtime.Object {
	if c := gsSet.DeepCopy(); c != nil {
		return c
	} else {
		return nil
	}
