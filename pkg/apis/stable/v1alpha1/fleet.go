...
// FleetScalingPolicy defines how to handle Horizontal Fleet Autoscaling
...
const (
	...
	// RollingBufferFleetScalingPolicyType - When using the simple buffer policy, 
	// the fleet will try to maintain a buffer of ready game server instances. 
