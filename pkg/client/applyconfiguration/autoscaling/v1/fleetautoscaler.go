...
func (b *FleetAutoscalerApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *FleetAutoscalerApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *FleetAutoscalerApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *FleetAutoscalerApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *FleetAutoscalerApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *FleetAutoscalerApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
...
func (b *FleetAutoscalerApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
