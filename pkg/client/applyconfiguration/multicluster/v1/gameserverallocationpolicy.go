...
func GameServerAllocationPolicy(name, namespace string) *GameServerAllocationPolicyApplyConfiguration {
	...
	b.WithKind("GameServerAllocationPolicy")
...
func (b *GameServerAllocationPolicyApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *GameServerAllocationPolicyApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *GameServerAllocationPolicyApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *GameServerAllocationPolicyApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *GameServerAllocationPolicyApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *GameServerAllocationPolicyApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
...
func (b *GameServerAllocationPolicyApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
