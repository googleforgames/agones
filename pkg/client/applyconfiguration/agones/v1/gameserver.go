...
// GameServerApplyConfiguration represents an declarative configuration of the GameServer type for use
// with apply.
...
// GameServer constructs an declarative configuration of the GameServer type for use with
// apply.
