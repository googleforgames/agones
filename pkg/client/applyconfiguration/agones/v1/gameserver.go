...
// GameServer constructs a declarative configuration of the GameServer type for use with
// apply.
func GameServer(name, namespace string) *GameServerApplyConfiguration {
	b := &GameServerApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("GameServer")
...
func (b *GameServerApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *GameServerApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *GameServerApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *GameServerApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *GameServerApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *GameServerApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
...
func (b *GameServerApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
...
func (b *GameServerApplyConfiguration) GetName() *string {
	b.ensureObjectMetaApplyConfigurationExists()
