...
func (b *GameServerTemplateSpecApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *GameServerTemplateSpecApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *GameServerTemplateSpecApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *GameServerTemplateSpecApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *GameServerTemplateSpecApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *GameServerTemplateSpecApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
...
func (b *GameServerTemplateSpecApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
