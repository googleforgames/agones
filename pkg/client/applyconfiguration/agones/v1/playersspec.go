...
// WithInitialCapacity sets the InitialCapacity field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the InitialCapacity field is set to the value of the last call.
func (b *PlayersSpecApplyConfiguration) WithInitialCapacity(value int64) *PlayersSpecApplyConfiguration {
	b.InitialCapacity = &value
	return b
}
