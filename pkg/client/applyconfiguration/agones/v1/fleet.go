...
func (b *FleetApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *FleetApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *FleetApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *FleetApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *FleetApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *FleetApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
