...
type GameServerAllocationPolicyInformer interface {
	...
	Lister() v1alpha1.GameServerAllocationPolicyLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MulticlusterV1alpha1().GameServerAllocationPolicies(namespace).List(options)
			},
...
func (f *gameServerAllocationPolicyInformer) Lister() v1alpha1.GameServerAllocationPolicyLister {
	return v1alpha1.NewGameServerAllocationPolicyLister(f.Informer().GetIndexer())
}
