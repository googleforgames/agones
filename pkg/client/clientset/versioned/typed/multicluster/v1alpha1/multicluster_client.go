...
// MulticlusterV1alpha1Client is used to interact with features provided by the multicluster.agones.dev group.
type MulticlusterV1alpha1Client struct {
	restClient rest.Interface
}

func (c *MulticlusterV1alpha1Client) GameServerAllocationPolicies(namespace string) GameServerAllocationPolicyInterface {
