...
type GameServerAllocationPolicyInterface interface {
	Create(*v1.GameServerAllocationPolicy) (*v1.GameServerAllocationPolicy, error)
	Update(*v1.GameServerAllocationPolicy) (*v1.GameServerAllocationPolicy, error)
	Delete(name string, options *metav1.DeleteOptions) error
	DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error
	Get(name string, options metav1.GetOptions) (*v1.GameServerAllocationPolicy, error)
	List(opts metav1.ListOptions) (*v1.GameServerAllocationPolicyList, error)
	Watch(opts metav1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.GameServerAllocationPolicy, err error)
...
func (c *gameServerAllocationPolicies) Get(name string, options metav1.GetOptions) (result *v1.GameServerAllocationPolicy, err error) {
...
func (c *gameServerAllocationPolicies) List(opts metav1.ListOptions) (result *v1.GameServerAllocationPolicyList, err error) {
...
func (c *gameServerAllocationPolicies) Watch(opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *gameServerAllocationPolicies) Create(gameServerAllocationPolicy *v1.GameServerAllocationPolicy) (result *v1.GameServerAllocationPolicy, err error) {
	result = &v1.GameServerAllocationPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("gameserverallocationpolicies").
...
func (c *gameServerAllocationPolicies) Update(gameServerAllocationPolicy *v1.GameServerAllocationPolicy) (result *v1.GameServerAllocationPolicy, err error) {
	result = &v1.GameServerAllocationPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("gameserverallocationpolicies").
...
func (c *gameServerAllocationPolicies) Delete(name string, options *metav1.DeleteOptions) error {
...
func (c *gameServerAllocationPolicies) DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *gameServerAllocationPolicies) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.GameServerAllocationPolicy, err error) {
	result = &v1.GameServerAllocationPolicy{}
