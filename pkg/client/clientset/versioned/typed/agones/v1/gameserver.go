...
func (c *gameServers) Create(gameServer *v1.GameServer) (result *v1.GameServer, err error) {
	result = &v1.GameServer{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("gameservers").
...
func (c *gameServers) Update(gameServer *v1.GameServer) (result *v1.GameServer, err error) {
	result = &v1.GameServer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("gameservers").
...
func (c *gameServers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.GameServer, err error) {
	result = &v1.GameServer{}
