...
// NewForConfigAndClient creates a new AllocationV1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*AllocationV1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
...
func setConfigDefaults(config *rest.Config) error {
	gv := allocationv1.SchemeGroupVersion
