...
type ControllerHooksInterface interface {
	...
	NewPortAllocator(int32, int32, map[string]portallocator.PortRange, informers.SharedInformerFactory, externalversions.SharedInformerFactory) portallocator.Interface
