...
func TestFindPackedReadyGameServer(t *testing.T) {
	...
	t.Run("test one", func(t *testing.T) {
		...
		gsList := []*v1alpha1.GameServer{
			...
			{ObjectMeta: metav1.ObjectMeta{Name: "gs2"}, Status: v1alpha1.GameServerStatus{NodeName: "node2", State: v1alpha1.GameServerStateReady}},
			...
			{ObjectMeta: metav1.ObjectMeta{Name: "gs5"}, Status: v1alpha1.GameServerStatus{NodeName: "node1", State: v1alpha1.GameServerStateError}},
		}
		...
		gsList[1].Status.State = v1alpha1.GameServerStateAllocated
		gs = findReadyGameServerForAllocation(gsList, packedComparator)
	...
	t.Run("allocation trap", func(t *testing.T) {
		gsList := []*v1alpha1.GameServer{
			{ObjectMeta: metav1.ObjectMeta{Name: "gs1"}, Status: v1alpha1.GameServerStatus{NodeName: "node1", State: v1alpha1.GameServerStateAllocated}},
			...
			{ObjectMeta: metav1.ObjectMeta{Name: "gs8"}, Status: v1alpha1.GameServerStatus{NodeName: "node2", State: v1alpha1.GameServerStateReady}},
		}
...
func TestFindDistributedReadyGameServer(t *testing.T) {
	...
	n := metav1.Now()
	gsList := []*v1alpha1.GameServer{
		{ObjectMeta: metav1.ObjectMeta{Name: "gs6", DeletionTimestamp: &n}, Status: v1alpha1.GameServerStatus{NodeName: "node3", State: v1alpha1.GameServerStateReady}},
		{ObjectMeta: metav1.ObjectMeta{Name: "gs1"}, Status: v1alpha1.GameServerStatus{NodeName: "node1", State: v1alpha1.GameServerStateReady}},
		...
		{ObjectMeta: metav1.ObjectMeta{Name: "gs5"}, Status: v1alpha1.GameServerStatus{NodeName: "node2", State: v1alpha1.GameServerStateReady}},
		{ObjectMeta: metav1.ObjectMeta{Name: "gs6"}, Status: v1alpha1.GameServerStatus{NodeName: "node2", State: v1alpha1.GameServerStateReady}},
		{ObjectMeta: metav1.ObjectMeta{Name: "gs7"}, Status: v1alpha1.GameServerStatus{NodeName: "node3", State: v1alpha1.GameServerStateReady}},
	}
	...
	gsList[7].Status.State = v1alpha1.GameServerStateAllocated

	gs = findReadyGameServerForAllocation(gsList, distributedComparator)
	assert.Equal(t, "node2", gs.Status.NodeName)
	assert.Equal(t, v1alpha1.GameServerStateReady, gs.Status.State)

	gsList[5].Status.State = v1alpha1.GameServerStateAllocated
	...
	gsList[6].Status.State = v1alpha1.GameServerStateAllocated
	...
	gsList[3].Status.State = v1alpha1.GameServerStateAllocated
