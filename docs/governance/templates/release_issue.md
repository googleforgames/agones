...
- [ ] Site updated
  ...
  - [ ] Add a link to previous version's documentation to nav dropdown in `site/layouts/partials/navbar.html` on top and Remove the last version's link from the bottom of that same dropdown.
  - [ ] config.toml updates:
