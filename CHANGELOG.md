...
## [v1.30.0](https://github.com/googleforgames/agones/tree/v1.30.0) (2023-02-28)
...
- Release 1.29.0 [\#2905](https://github.com/googleforgames/agones/issues/2905)
- Remove Release Candidate releases \[Previously: Poll\] [\#2854](https://github.com/googleforgames/agones/issues/2854)

**Merged pull requests:**

- Flaky: TestControllerSyncGameServerCreatingState [\#2995](https://github.com/googleforgames/agones/pull/2995) ([markmandel](https://github.com/markmandel))
- Test Example Images Exist - Release Automation [\#2989](https://github.com/googleforgames/agones/pull/2989) ([Kalaiselvi84](https://github.com/Kalaiselvi84))
- Make up{} work with Google Managed Prometheus [\#2986](https://github.com/googleforgames/agones/pull/2986) ([zmerlynn](https://github.com/zmerlynn))
- Fix label\_values for Google Managed Prometheus [\#2984](https://github.com/googleforgames/agones/pull/2984) ([zmerlynn](https://github.com/zmerlynn))
- Make Alpha & Beta CRD declaration consistent. [\#2982](https://github.com/googleforgames/agones/pull/2982) ([markmandel](https://github.com/markmandel))
- Update the apiserver request dashboard [\#2963](https://github.com/googleforgames/agones/pull/2963) ([zmerlynn](https://github.com/zmerlynn))
- Add documentation for SplitControllerAndExtensions [\#2961](https://github.com/googleforgames/agones/pull/2961) ([chiayi](https://github.com/chiayi))
- Do not install Consul in e2e test cluster [\#2959](https://github.com/googleforgames/agones/pull/2959) ([gongmax](https://github.com/gongmax))
- Update examples to use the Dynamic port policy instead of Static [\#2957](https://github.com/googleforgames/agones/pull/2957) ([roberthbailey](https://github.com/roberthbailey))
- Allow occasional flakes in SDK conformance tests [\#2955](https://github.com/googleforgames/agones/pull/2955) ([zmerlynn](https://github.com/zmerlynn))
- Graduate `SafeToEvict` to Beta [\#2950](https://github.com/googleforgames/agones/pull/2950) ([zmerlynn](https://github.com/zmerlynn))
- Move the e2e test steps to a child Cloud Build [\#2949](https://github.com/googleforgames/agones/pull/2949) ([gongmax](https://github.com/gongmax))
- Remove apiHooks singleton [\#2948](https://github.com/googleforgames/agones/pull/2948) ([zmerlynn](https://github.com/zmerlynn))
- Run `build-release` within build image [\#2945](https://github.com/googleforgames/agones/pull/2945) ([markmandel](https://github.com/markmandel))
- Fix Typo in Rust Doc [\#2944](https://github.com/googleforgames/agones/pull/2944) ([ArtyomKaltovich](https://github.com/ArtyomKaltovich))
- Block on Autopilot in CI [\#2941](https://github.com/googleforgames/agones/pull/2941) ([zmerlynn](https://github.com/zmerlynn))
- Use Server Side Apply to mitigate the 'metadata.annotations: Too long: must have at most 262144 bytes' error [\#2936](https://github.com/googleforgames/agones/pull/2936) ([gongmax](https://github.com/gongmax))
- Run e2es in fair order, eliminate need for consul [\#2932](https://github.com/googleforgames/agones/pull/2932) ([zmerlynn](https://github.com/zmerlynn))
- Actually bump consul timeout [\#2930](https://github.com/googleforgames/agones/pull/2930) ([zmerlynn](https://github.com/zmerlynn))
- Remove rc from the includes [\#2929](https://github.com/googleforgames/agones/pull/2929) ([Kalaiselvi84](https://github.com/Kalaiselvi84))
- Bump the cloud build expiration time, we can no longer retry [\#2927](https://github.com/googleforgames/agones/pull/2927) ([zmerlynn](https://github.com/zmerlynn))
- Remove release candidate steps from the docs [\#2919](https://github.com/googleforgames/agones/pull/2919) ([Kalaiselvi84](https://github.com/Kalaiselvi84))
- Move pooneh-m to emeritus approvers [\#2916](https://github.com/googleforgames/agones/pull/2916) ([pooneh-m](https://github.com/pooneh-m))
- Preparation for 1.29.0 [\#2911](https://github.com/googleforgames/agones/pull/2911) ([Kalaiselvi84](https://github.com/Kalaiselvi84))
- Use containerd runtime based Windows image [\#2910](https://github.com/googleforgames/agones/pull/2910) ([gongmax](https://github.com/gongmax))
- Fix: Updates README.md by removing dead links [\#2908](https://github.com/googleforgames/agones/pull/2908) ([Nitinbabariya](https://github.com/Nitinbabariya))
- Removes explicit versions of Prometheus and Grafana [\#2898](https://github.com/googleforgames/agones/pull/2898) ([igooch](https://github.com/igooch))
