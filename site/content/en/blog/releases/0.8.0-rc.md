...
Details:
https://github.com/googleforgames/agones/releases/tag/v0.8.0-rc

Check the [README](https://github.com/googleforgames/agones/tree/release-0.8.0-rc) for details on features, installation and usage.
...
- Adds gameservers per node count and distribution [\#551](https://github.com/googleforgames/agones/pull/551) ([Kuqd](https://github.com/cyriltovena))
...
- add client-go metrics and grafana dashboards [\#505](https://github.com/googleforgames/agones/pull/505) ([Kuqd](https://github.com/cyriltovena))
...
- Add pod tolerations, nodeSelector and affinity in helm [\#473](https://github.com/googleforgames/agones/pull/473) ([Kuqd](https://github.com/cyriltovena))
- adding Prometheus+Grafana for metrics and visualizations [\#472](https://github.com/googleforgames/agones/pull/472) ([Kuqd](https://github.com/cyriltovena))
...
See [CHANGELOG](https://github.com/googleforgames/agones/blob/release-0.8.0-rc/CHANGELOG.md) for more details on changes.
