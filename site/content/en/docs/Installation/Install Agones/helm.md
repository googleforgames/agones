...
| `agones.extensions.disableSecret`                        | Disables the creation of any allocator secrets. If not set, this parameter falls back to the value of `.Values.agones.controller.disableSecret`. You MUST provide the `{agones.releaseName}-cert` secrets before installation if this is set to `true`.                                                                                                                                                                           | `false`                                   |
| `agones.extensions.customCertSecretPath`                 | Remap cert-manager path to server.crt and server.key                                                                                                                                                                                                                                                             | `{}`                                      |
| `agones.extensions.allocationApiService.annotations`     | [Annotations][annotations] added to the Agones API registration. If not set, this parameter defaults to the value of `.Values.agones.controller.allocationApiService.annotations`.                                                                                                                                                                                                                                                   | `{}`                                      |
| `agones.extensions.allocationApiService.disableCaBundle` | Disable ca-bundle so it can be injected by cert-manager. If not set, this parameter defaults to the value of `.Values.agones.controller.allocationApiService.disableCaBundle`.                                                                                                                                                                                                                                                          | `false`                                   |
| `agones.extensions.validatingWebhook.annotations`        | [Annotations][annotations] added to the Agones validating webhook.  If not set, this parameter defaults to the value of `.Values.agones.controller.validatingWebhook.annotations`.                                                                                                                                                                                                                                                | `{}`                                      |
| `agones.extensions.validatingWebhook.disableCaBundle`    | Disable ca-bundle so it can be injected by cert-manager. If not set, this parameter defaults to the value of `.Values.agones.controller.validatingWebhook.disableCaBundle`.                                                                                                                                                                                                                                                          | `false`                                   |
| `agones.extensions.mutatingWebhook.annotations`          | [Annotations][annotations] added to the Agones mutating webhook. If not set, this parameter defaults to the value of `.Values.agones.controller.mutatingWebhook.annotations`.                                                                                                                                                                                                                                                  | `{}`                                      |
| `agones.extensions.mutatingWebhook.disableCaBundle`      | Disable ca-bundle so it can be injected by cert-manager.  If not set, this parameter defaults to the value of `.Values.agones.controller.mutatingWebhook.disableCaBundle`.                                                                                                                                                                                                                                                          | `false`                                   |
...
| `agones.extensions.pdb.maxUnavailable`                   | Description of the number of pods from that set that can be unavailable after the eviction. It can be either an absolute number or a percentage Mutually Exclusive with `minAvailable`. If not set, this parameter defaults to the value of `.Values.agones.controller.pdb.maxUnavailable`.                                                                                                                           | \`\`                                      |
