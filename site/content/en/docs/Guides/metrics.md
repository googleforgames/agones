...
| agones_gameservers_players_in_game                    | The total number of players connected to gameservers (Only available when [player tracking]({{< relref "player_tracking.md" >}}) is enabled)                                              | gauge     |
