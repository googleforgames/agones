...
| Fix for RollingUpdate [Scale down](https://github.com/googleforgames/agones/issues/1625) and additional [details]({{< ref "/docs/Guides/fleet-updates.md#beta-feature-rollingupdateonready" >}}) | `RollingUpdateOnReady` | Enabled | `Beta` | 1.9.0 |
