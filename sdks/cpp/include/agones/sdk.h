...
namespace agones {
    ...
    public:
        ...
        AGONES_EXPORT grpc::Status GameServer(stable::agones::dev::sdk::GameServer* response);
        ...
        AGONES_EXPORT grpc::Status WatchGameServer(const std::function<void(stable::agones::dev::sdk::GameServer)>& callback);
