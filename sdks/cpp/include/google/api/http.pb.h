...
/* @@protoc_insertion_point(class_definition:google.api.CustomHttpPattern) */ {
 public:
  ...
  void operator delete(CustomHttpPattern* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  CustomHttpPattern* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:google.api.HttpRule) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(HttpRule* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  HttpRule* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:google.api.Http) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(Http* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  Http* New(::google::protobuf::Arena* arena = nullptr) const {
